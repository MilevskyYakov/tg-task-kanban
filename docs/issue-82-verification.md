...
**Итоговый статус:** MCP и клиентские инструкции выпущены в production через PR #90/#91/#92. Настоящий Hermes smoke с UI readback и отзывом выполнен; [итоговый отчёт](issue-82-production-smoke.md). Ниже сохранены результаты и ограничения первоначального локального этапа, а не текущий статус релиза. Восстановление отозванного подключения владелец отложил.
