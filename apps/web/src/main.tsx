...
function App() {
  ...
  const openCollaboration = async (task: Task) => {
    try { await loadTaskDetails(task); }
    catch (error) { setMessage(error instanceof Error ? error.message : 'Ошибка'); }
  };
